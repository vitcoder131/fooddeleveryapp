...
int a =1;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      Image.asset("images/salad2.png", width: MediaQuery.of(context).size.width, height: MediaQuery.of(context).size.height/3, fit: BoxFit.fill,),
      SizedBox(height: 15,),
      ...
      SizedBox(width: 20,),
      Text("This chickpea salad is healthy, satisfying, flavorful, and fresh. It’s exactly the sort of thing I like to make for picnics and lunches throughout the summer. Just add a side of sunshine to make it a meal. Enjoy!", maxLines: 3, style: AppWidget.LightTextFeildStyle(),),
      SizedBox(height: 30,),
      Row(children: [
